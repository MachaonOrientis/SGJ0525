...
# Пользовательские стили и прочее

style bar_mhp:
    xsize 150
    ysize 25
    left_bar Frame("gui/bar/hp_left.png", gui.bar_borders)
    right_bar Frame("gui/bar/hp_right.png", gui.bar_borders)
...
define gui.text_font = "DaneehandRegularCyr.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "DaneehandRegularCyr.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "DuduCyrillic.ttf"
